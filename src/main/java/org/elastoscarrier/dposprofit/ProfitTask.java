...
public class ProfitTask {
    ...
    private void voterProfitMethod(long superNodeVoteNum, long superNodeProfitValue, List<Map<String, String>> result, Map<String, Long> profitDetail) {
        ...
        long profitValuePerVote = (superNodeProfitValue - 10000000) * 8 / 10 / superNodeVoteNum;
        ...
        profitDetail.put("EYvuucWJb1v2bzh42iJog5Gn57z1zHnzLG", profitDetail.get("EYvuucWJb1v2bzh42iJog5Gn57z1zHnzLG") + reservedValue / 5);
        profitDetail.put("EQLp9LCrhxKwPEgfySzEGsFL4Sf4Vyj2GV", profitDetail.get("EQLp9LCrhxKwPEgfySzEGsFL4Sf4Vyj2GV") + reservedValue / 5);
